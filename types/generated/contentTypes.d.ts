...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    >;
    contractedServices: Schema.Attribute.Relation<
      'oneToMany',
      'api::contracted-service.contracted-service'
    >;
...
export interface ApiContractedServiceContractedService
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    acquisitionDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ...
    adminPanelURL: Schema.Attribute.String;
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    customer: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    invoiceDetails: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiQuotationQuotation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    quotationNumber: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    issueDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ...
    customer: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    quotationDetails: Schema.Attribute.Relation<
      'oneToMany',
      'api::quotation-detail.quotation-detail'
    >;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiQuotationDetailQuotationDetail
  extends Struct.CollectionTypeSchema {
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    billingForm: Schema.Attribute.Enumeration<
      ['Monthly', 'Annual', 'Single Payment']
    >;
    contractedServices: Schema.Attribute.Relation<
      'oneToMany',
      'api::contracted-service.contracted-service'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contracted-service.contracted-service': ApiContractedServiceContractedService;
      ...
      'api::quotation-detail.quotation-detail': ApiQuotationDetailQuotationDetail;
